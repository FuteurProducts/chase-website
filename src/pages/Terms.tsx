        ...
        <div className={containerClass}>
          ...
          >
            <Card className={neutralCard}>
              <CardHeader>
                <CardTitle className="text-[#070707] dark:text-white">1. Acceptance of Terms</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-[#070707]/80 dark:text-white/70">
                  By accessing or using the Chase Business Credit Journey demonstration site and related LUMIQ AI services (collectively, the "Services"), you agree to be bound by these Terms of Service. If you do not agree to these terms, do not use the Services.
                </p>
                <p className="text-[#070707]/80 dark:text-white/70 mt-4">
                  This demonstration site is intended for evaluation purposes by Chase and authorized representatives. Production deployment and pilot programs are governed by separate Master Service Agreements.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className={neutralCard}>
              <CardHeader>
                <CardTitle className="text-[#070707] dark:text-white">2. Service Description</CardTitle>
              </CardHeader>
            ...
            <Card className={neutralCard}>
              <CardHeader>
                <CardTitle className="text-[#070707] dark:text-white">3. Authorized Use</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <h3 className="font-semibold text-[#070707] dark:text-white mb-2">Permitted Use</h3>
                  <p className="text-sm text-[#070707]/80 dark:text-white/70">
                ...
                <div>
                  <h3 className="font-semibold text-[#070707] dark:text-white mb-2">Prohibited Activities</h3>
                  <p className="text-sm text-[#070707]/80 dark:text-white/70 mb-2">You may not:</p>
                  <ul className="space-y-1 text-sm text-[#070707]/80 dark:text-white/70 list-disc list-inside">
            ...
            <Card className={neutralCard}>
              <CardHeader>
                <CardTitle className="text-[#070707] dark:text-white">4. Data Ownership & Usage Rights</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <h3 className="font-semibold text-[#070707] dark:text-white mb-2">Customer Data</h3>
                  <p className="text-sm text-[#070707]/80 dark:text-white/70">
                ...
                <div>
                  <h3 className="font-semibold text-[#070707] dark:text-white mb-2">Credit Bureau Data</h3>
                  <p className="text-sm text-[#070707]/80 dark:text-white/70">
                ...
                <div>
                  <h3 className="font-semibold text-[#070707] dark:text-white mb-2">Aggregated Analytics</h3>
                  <p className="text-sm text-[#070707]/80 dark:text-white/70">
            ...
            <Card className={neutralCard}>
              <CardHeader>
                <CardTitle className="text-[#070707] dark:text-white">5. Intellectual Property</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-[#070707]/80 dark:text-white/70">
                ...
                <p className="text-sm text-[#070707]/80 dark:text-white/70 mt-4">
                  "LUMIQ AI", "FuteurCredX", and associated logos are trademarks of FuteurCredX. Chase trademarks are used with permission solely for demonstration purposes.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className={neutralCard}>
              <CardHeader>
                <CardTitle className="text-[#070707] dark:text-white">6. Service Availability & Support</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <h3 className="font-semibold text-[#070707] dark:text-white mb-2">Uptime Commitment</h3>
                  <p className="text-sm text-[#070707]/80 dark:text-white/70">
                ...
                <div>
                  <h3 className="font-semibold text-[#070707] dark:text-white mb-2">Maintenance Windows</h3>
                  <p className="text-sm text-[#070707]/80 dark:text-white/70">
            ...
            <Card className={neutralCard}>
              <CardHeader>
                <CardTitle className="text-[#070707] dark:text-white">7. Disclaimer of Warranties</CardTitle>
              </CardHeader>
              <CardContent>
            ...
            <Card className={neutralCard}>
              <CardHeader>
                <CardTitle className="text-[#070707] dark:text-white">8. Limitation of Liability</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-[#070707]/80 dark:text-white/70 mb-4">
            ...
            <Card className={neutralCard}>
              <CardHeader>
                <CardTitle className="text-[#070707] dark:text-white">9. Indemnification</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-[#070707]/80 dark:text-white/70">
            ...
            <Card className={neutralCard}>
              <CardHeader>
                <CardTitle className="text-[#070707] dark:text-white">10. Compliance with Credit Reporting Laws</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <p className="text-sm text-[#070707]/80 dark:text-white/70">
            ...
            <Card className={neutralCard}>
              <CardHeader>
                <CardTitle className="text-[#070707] dark:text-white">11. Term & Termination</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-[#070707]/80 dark:text-white/70">
            ...
            <Card className={neutralCard}>
              <CardHeader>
                <CardTitle className="text-[#070707] dark:text-white">12. Changes to Terms</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-[#070707]/80 dark:text-white/70">
            ...
            <Card className={neutralCard}>
              <CardHeader>
                <CardTitle className="text-[#070707] dark:text-white">13. Governing Law & Dispute Resolution</CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div>
                  <h3 className="font-semibold text-[#070707] dark:text-white mb-2">Governing Law</h3>
                  <p className="text-sm text-[#070707]/80 dark:text-white/70">
                    These Terms are governed by the laws of the State of New York, without regard to conflict of law principles.
                  </p>
                </div>
                <div>
                  <h3 className="font-semibold text-[#070707] dark:text-white mb-2">Dispute Resolution</h3>
                  <p className="text-sm text-[#070707]/80 dark:text-white/70">
            ...
            <Card className={neutralCard}>
              <CardHeader>
                <CardTitle className="text-[#070707] dark:text-white">14. Contact Information</CardTitle>
              </CardHeader>
              <CardContent>
                <p className="text-sm text-[#070707]/80 dark:text-white/70 mb-4">
